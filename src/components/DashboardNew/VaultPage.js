...
const [selectedDropdown, setSelectedDropdown] = useState('USDC');
    ...
    //   };
      ...
      const approveUSDC = async () => {
        ...
        try {
          ...
          const usdcContract = new ethers.Contract(USDCAddress, usdcabi, web31.getSigner(account));
    ...
    const approve = async () => {
        ...
        try {
            ...
            const usdcContract = new ethers.Contract(USDCAddress, usdcabi, web3.getSigner(account));
            const creditsContract = new ethers.Contract(creditsaddress, creditsabi, web3.getSigner(account));
           ...
           // const usdcAllowance = ethers.utils.formatUnits(await usdcContract.allowance(account, carbonfinance), 0);
    
            // Check allowance for CREDIT
            //const creditsAllowance = ethers.utils.formatUnits(await creditsContract.allowance(account, carbonfinance), 0);
