...
const Stablecoin = () => {
    ...
    const connectToEthereum = async () => {
      ...
      const calculateDimeCreditmint = async(value)=>{
        ...
        let dimeTokenMint = (value * 1e9 * dimePrice)/tauprice;
      ...
      const calculateDime = async(value)=>{
        ...
        let dimeTokenMint = (value * 1e9 * tauprice)/dimePrice;
        setDimeToken(dimeTokenMint);
...
const rollover = async() =>{
    ...
    try{
        ...
        const mintTx = await rolloverContract.deposit(dimeAmountBN);
        await mintTx.wait();
...
const approveTAU = async() =>{
    ...
    const usdcMaxTau = () =>
    {
        setDaiAmount(dimeBalance/1e9);
        calculateDimeCreditmint(dimeBalance/1e9)
    }
                    ...
                    <Col md={10} lg={7} className="mb-4">
                        ...
                        <Card className='card-dash d-block border-0 mb-4'>
                            ...
                            <Tabs defaultActiveKey="mint" className='dashboard-tabs' id="tab-example-1">
                                <Tab eventKey="mint" title="Rollover">
                                    ...
                                    <div className="mb-20">
                                        ...
                                        <div className="d-flex mb-1 align-items-center justify-content-between text-md">
                                            ...
                                            <strong className='font-semibold'> 1 DIME  = 0.1 TAU</strong>
                                        </div>
                                        {/* <div className="d-flex mb-1 align-items-center justify-content-between text-md">
                                ...
                                <Tab eventKey="redeem" title="Redemption">
                                <div className="group-row mb-20">
                                        <Row>
                                            <Col sm={5} className="mb-sm-0 mb-3">
                                                <Button variant='link' className='btn-currency p-0'>
                                    ...
                                    <div className="mb-20">
                                        ...
                                        <div className="d-flex mb-1 align-items-center justify-content-between text-md">
                                            <span>Exchange Rate </span>
                                            <strong className='font-semibold'> 1 TAU  = 10 DIME</strong>
                                        </div>
                                        {/* <div className="d-flex mb-1 align-items-center justify-content-between text-md">
                                            <span>Minting Fee </span>
                                            <strong className='font-semibold'>5% JOKER</strong>
